...
#' @title extract important gene ratio;
#' @description
...
#' @param all_reversed_gp_genes all_reversed_gp_genes which is the differentially ranked genes ratio selected in previous RRA() function.
#'
